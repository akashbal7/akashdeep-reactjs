...
import logo_set2go from "./logo_set2go.png";
...
export const restaurantList = [
  {
    ...
    image: res1,
    description:
      "A fresh and healthy place offering a variety of salads made from locally sourced ingredients.",
    address: {
      line1: "123 Green Street",
      city: "Brampton",
      state: "ON",
      postalCode: "L6T 3R5",
      fullAddress: "123 Green Street, Brampton, ON, L6T 3R5",
    },
    phone: "123-456-7890",
  ...
  },
  {
    ...
    image: res2,
    description:
      "A popular spot for vegetarians and salad lovers, offering creative and nutritious salad options.",
    address: {
      line1: "456 Salad Avenue",
      city: "Mississauga",
      state: "ON",
      postalCode: "L4T 1A1",
      fullAddress: "456 Salad Avenue, Mississauga, ON, L4T 1A1",
    },
    phone: "987-654-3210",
    email: "info@saladhaven.com",
    website: "https://saladhaven.com",
    openingHours: {
      days: "Sat-Sun",
