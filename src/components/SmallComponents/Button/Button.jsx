...
const Button = ({ children, color = "blue", className = "", ...props }) => {
  ...
  return (
    <button className="text-white mt-2 bg-emerald-400 hover:bg-emerald-800 focus:ring-4 focus:ring-emerald-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none dark:bg-blue-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800">
      {children}
    </button>
  );
};
